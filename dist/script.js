...
window.addEventListener('DOMContentLoaded', () => {
  ...
  _modules_modals__WEBPACK_IMPORTED_MODULE_1___default()(modalState);
...
function changeModalState(state) {
  ...
  bindActionToElems('input', windowHeigth, 'heidht');
...
function show_modal(state) {
  ...
  openModal('.phone_link', '.popup', '.popup .popup_close'); // openModalByTime('.popup', 60000);
  ...
  openModal('.popup_calc_profile_button', '.popup_calc_end', '.popup_calc_end_close', false); // Код выше оптимизировал после просмотра видео
